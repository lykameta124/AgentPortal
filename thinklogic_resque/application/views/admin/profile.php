<div class="container-fluid">
                ...
                <center>
                    <div class="col-lg-4">
                      ...
                      <div class="col-sm-12">
                      <br><br>
                        <?php echo form_open_multipart('admin/upload_picture/' . $row->emp_id); ?>
                ...
                <div class="col-lg-8">
                    ...
                    <?php echo form_open('admin/update_employee', array('class' => 'form-horizontal' ));?>
                      ...
                      <div class="form-group col-md-11">
                        ...
                        <?php echo anchor('admin/edit_employee/'.$row->emp_id,'Edit Profile',array('class'=>'btn btn-primary pull-right')) ?>
                        <?php echo anchor('admin/employees','Cancel',array('class'=>'btn btn-default pull-right')) ?>&nbsp;&nbsp;&nbsp;
                        <br><br><br><br><br><br>
                      </div>
                    <?php echo form_close();?>
                    <?php } ?>
