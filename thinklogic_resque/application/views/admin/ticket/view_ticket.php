			...
			<center>				
				<div class="form-horizontal">
					...
					<?php if($assign == FALSE){?>
						...
						<hr/>
						<form method="POST" class="form-horizontal" action="<?php echo base_url().'admin/' ;?>add_ticketAssign">
							<div class="row">
									...
									<select class="form-control" name="emp_id" required>
										...
										<?php foreach($employee as $emp): ?>
											<?php if ($emp->emp_id != $this->session->userdata('emp_id')){?>
												<option value="<?php echo $emp->emp_id; ?>" placeholder="asdasdasd"><?php echo $emp->first_name." ".$emp->middle_name." ".$emp->last_name;?></option>
										<?php } endforeach; ?>
							...
							<div class="form-group form-group-sm">
								<center>
									...
									<input type="submit" class="btn btn-success confirmation" value="Assign">
								</center>
							</div> 
