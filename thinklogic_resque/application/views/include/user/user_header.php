...
<head>
	<title>ThinkLogic ResQue | User</title>
	<meta charset="utf-8">
					...
					<ul class="nav">
						...
						<li>
							...
							<div id="account" class="collapse ">
								<ul class="nav">
									<li><a href="<?php echo base_url();?>user/profile" class=""><i class="fa fa-circle-o" style="font-size: 10px;"></i>Profile</a></li>
									<li><a href="<?php echo base_url();?>user/settings" class=""><i class="fa fa-circle-o" style="font-size: 10px;"></i>Settings</a></li>
								</ul>
							</div>
						</li>
						<li><a href="<?php echo base_url();?>user/tickets" class=""><i class="fa fa-ticket" ></i>Tickets</a></li>
						<li><a href="<?php echo base_url();?>user/myTeam" class=""><i class="fa fa-users"></i>My Team</a></li>
						<li style="position: fixed;bottom: 0px; left: 0px; }">
						<a href="<?php echo base_url();?>user/logout" class=""><i class="fa fa-sign-out" ></i>Log Out</a></li>
						<br>
						<br>
					</ul>
				</nav>
