<div class="container-fluid">
                ...
                <center>
                    <div class="col-lg-4">
                      ...
                      <div class="col-sm-12">
                      <br><br>
                        <?php echo form_open_multipart('user/upload_picture/' . $row->emp_id); ?>
                ...
                <div class="col-lg-8">
                    ...
                    <?php echo form_open('user/update_profile', array('class' => 'form-horizontal' ));?>
                      ...
                      <div class="form-group col-md-11">
                        ...
                        <?php echo anchor('user/edit_profile/'.$row->emp_id,'Edit Profile',array('class'=>'btn btn-primary pull-right')) ?>
                        <br><br><br><br><br><br>
                      </div>
                    <?php echo form_close();?>
                    <?php } ?>
