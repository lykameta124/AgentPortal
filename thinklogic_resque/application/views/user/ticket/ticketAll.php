		                    ...
		                    <tbody>
								<?php foreach ($ticket as $name ):?>
									...
									<tr <?php if($name->ticket_status == "Open"){ echo 'style="font-weight:bold"'; }?> >
										...
										<td>
											<a href="<?php echo base_url();?>user/edit_ticket/<?php echo $name->ticket_id; ?>">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
			<form class="form-horizontal" action="<?php echo base_url();?>user/add_Ticket" method="POST">
